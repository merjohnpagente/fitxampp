...
echo "<li>Project folder must be at <code>C:/xampp/htdocs/fitcore-gms/</code> (or adjust APP_URL in config.php).</li>";
echo "<li>Visit <a href='index.html'>index.html</a> via <code>http://localhost/fitcore-gms/</code> — you should see “● MySQL Connected” badge at bottom-right.</li>";
